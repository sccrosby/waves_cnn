...
t = text(0.05, 23.5, '(a)', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top');
PLT.plot_inter_buoy_hs_swell(PLT, buoy_46211, buoy_46214__46211, buoy_46218__46211, mycolors)
...
ph(2)=plot([0 10],[-5 -5],'-','Color',mycolors(1,:),'MarkerFaceColor',mycolors(1,:));
ph(3)=plot([0 10],[-5 -5],'-','Color',mycolors(2,:),'MarkerFaceColor',mycolors(2,:));
ph(4)=plot([0 10],[-5 -5],'-','Color',mycolors(3,:),'MarkerFaceColor',mycolors(3,:));
% ph(5)=plot([0 10],[-5 -5],'s','Color',mycolors(4,:),'MarkerFaceColor',mycolors(4,:));
% ph(6)=plot([0 10],[-5 -5],'s','Color',mycolors(5,:),'MarkerFaceColor',mycolors(5,:));

lh = legend(ph, 'WW3-debiased', '46211', '46214', '46218');
set(lh,'box','off')
...
% 
% lh = legend(ph, 'WW3-debiased', '46211', '46214', '46218', '24-hour', '48-hour');
% set(lh,'box','off')
% set(lh,'Location','southeast')
...
hold on
PLT.plot_inter_buoy_hs_swell(PLT, buoy_46211__46214, buoy_46214, buoy_46218__46214, mycolors)
ylim(myylimhs)
...
title('46218 - Harvest')
hold on
PLT.plot_inter_buoy_hs_swell(PLT, buoy_46211__46218, buoy_46214__46218, buoy_46218, mycolors)
ylim(myylimhs)
...
PLT.plot_inter_buoy_theta_swell(PLT, buoy_46211, buoy_46214__46211, buoy_46218__46211, mycolors, num_hours)
...
PLT.plot_inter_buoy_theta_swell(PLT, buoy_46211__46214, buoy_46214, buoy_46218__46214, mycolors, num_hours)
ylim(myylim)
set(gca,'YTickLabel',[]);
...
PLT.plot_inter_buoy_theta_swell(PLT, buoy_46211__46218, buoy_46214__46218, buoy_46218, mycolors, num_hours)
ylim(myylim)
...
% FINALLY
%%%%
printFig(gcf,'fig_inter_hour_swell',[8 5],'png')
