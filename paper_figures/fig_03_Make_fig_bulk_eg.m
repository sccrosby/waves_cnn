...
% Set number of predictoin examples you want
num_pred_ex = 10;

% Set parameters
hstart = 3960+84*24;
flen = 24*(num_pred_ex+1);
look_back = 6;
fstartV = 24:24:24*num_pred_ex;
...
xlim([sdate edate])
text(sdate + 3/24, 212, '(b)', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'fontsize', 8);
...
xlim([sdate edate])
text(sdate + 3/24, 8.25, '(c)', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'fontsize', 8);
...
% DATE LABELS AT BOTTOM OF LAST GRAPH
set(gca,'XTickLabelRotation',35)



% PRINTING
printFig(gcf,'Figure03-bulk-eg1',[6.5 6],'pdf')

%% POSTER PRINTING
% printFig(gcf,'poster_03_bulk_eg1',[6.5 6],'png',1000)
% printFig(gcf,'poster_03_bulk_eg1_flat',[6.5 4.75],'png',1000)
