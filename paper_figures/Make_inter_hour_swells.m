...
PLT.plot_inter_hr_hs_swell(PLT, buoy_46211_6, buoy_46211_12, buoy_46211_24, buoy_46211_48, mycolors)
...
% Legend falseplots
ph(1)=plot([0 10],[-5 -5],'-','Color',PLT.ww3_color,'MarkerFaceColor',PLT.ww3_color,'LineWidth',1.0);
ph(2)=plot([0 10],[-5 -5],'--','Color',PLT.ww3_adj_color,'MarkerFaceColor',PLT.ww3_adj_color,'LineWidth',1.0);
ph(3)=plot([0 10],[-5 -5],'-','Color',mycolors(1,:),'MarkerFaceColor',mycolors(1,:),'LineWidth',1.0);
ph(4)=plot([0 10],[-5 -5],'-','Color',mycolors(2,:),'MarkerFaceColor',mycolors(2,:),'LineWidth',1.0);
ph(5)=plot([0 10],[-5 -5],'-','Color',mycolors(3,:),'MarkerFaceColor',mycolors(3,:),'LineWidth',1.0);
ph(6)=plot([0 10],[-5 -5],'-','Color',mycolors(4,:),'MarkerFaceColor',mycolors(4,:),'LineWidth',1.0);

lh = legend(ph, 'WW3','WW3-debiased','6-hour SWRL Net', '12-hour SWRL Net', '24-hour SWRL Net', '48-hour SWRL Net');
set(lh,'box','off')
...
title('Point Reyes')
hold on
PLT.plot_inter_hr_hs_swell(PLT, buoy_46214_6, buoy_46214_12, buoy_46214_24, buoy_46214_48, mycolors)
ylim(myylimhs)
...
title('Harvest')
hold on
PLT.plot_inter_hr_hs_swell(PLT, buoy_46218_6, buoy_46218_12, buoy_46218_24, buoy_46218_48, mycolors)
ylim(myylimhs)
...
PLT.plot_inter_hr_theta_swell(PLT, buoy_46211_6, buoy_46211_12, buoy_46211_24, buoy_46211_48, mycolors, num_hours)
...
PLT.plot_inter_hr_theta_swell(PLT, buoy_46214_6, buoy_46214_12, buoy_46214_24, buoy_46214_48, mycolors, num_hours)
ylim(myylim)
set(gca,'YTickLabel',[]);
...
PLT.plot_inter_hr_theta_swell(PLT, buoy_46218_6, buoy_46218_12, buoy_46218_24, buoy_46218_48, mycolors, num_hours)
ylim(myylim)
...
PLT.plot_inter_hr_period_swell(PLT, buoy_46211_6, buoy_46211_12, buoy_46211_24, buoy_46211_48, mycolors)
ylim(myylimtm)
...
PLT.plot_inter_hr_period_swell(PLT, buoy_46214_6, buoy_46214_12, buoy_46214_24, buoy_46214_48, mycolors)
ylim(myylimtm)
...
PLT.plot_inter_hr_period_swell(PLT, buoy_46218_6, buoy_46218_12, buoy_46218_24, buoy_46218_48, mycolors)
ylim(myylimtm)
...
% FINALLY
%%%%
printFig(gcf,'fig_05_inter_hour_swell',[6.5 6],'pdf')
