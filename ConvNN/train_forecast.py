...
import math
import wandb
from ConvNN.cnn_forecast import ConvNN
from data_utils.forecast_batcher import Dataset
...
data_location = '/research/hutchinson/projects/ml_waves19/ml_waves19_chloe/datasets/forecast_data/'
model_location = '/research/hutchinson/projects/ml_waves19/ml_waves19_chloe/models/'
if BUOY == 46211:
    print("Buoy: ",BUOY)
    files = {
        'file_prefix': data_location,
        'train_file': '46211_waves_TRAIN_2021-07-13.npz',
        'dev_file':   '46211_waves_DEV_2021-07-13.npz',
        'test_file':  '46211_waves_TEST_2021-07-13.npz',
    ...
    files = {
        'file_prefix': data_location,
        'train_file': '46214_waves_TRAIN_2021-07-13.npz',
        'dev_file':   '46214_waves_DEV_2021-07-13.npz',
        'test_file':  '46214_waves_TEST_2021-07-13.npz',
    ...
    files = {
        'file_prefix': data_location,
        'train_file': '46218_waves_TRAIN_2021-07-12.npz',
        'dev_file':   '46218_waves_DEV_2021-07-12.npz',
        'test_file':  '46218_waves_TEST_2021-07-12.npz',
    ...
    files = {
        'file_prefix': data_location,
        'train_file': '46015_waves_TRAIN_2021-07-18.npz',
        'dev_file':   '46015_waves_DEV_2021-07-18.npz',
        'test_file':  '46015_waves_TEST_2021-07-18.npz',
    ...
    files = {
        'file_prefix': data_location,
        'train_file': '46027_waves_TRAIN_2021-07-18.npz',
        'dev_file':   '46027_waves_DEV_2021-07-18.npz',
        'test_file':  '46027_waves_TEST_2021-07-18.npz',
    ...
    files = {
        'file_prefix': data_location,
        'train_file': '46029_waves_TRAIN_2021-07-18.npz',
        'dev_file':   '46029_waves_DEV_2021-07-18.npz',
        'test_file':  '46029_waves_TEST_2021-07-18.npz',
